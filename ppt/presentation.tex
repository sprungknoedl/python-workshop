...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item posixpath for UNIX-style paths
		\item ntpath for Windows paths
		\item macpath for old-style MacOS paths
		\item os2emxpath for OS/2 EMX paths
	\end{itemize}
	\end{itemize}
...
>>> os.path.abspath(os.getcwd() + os.path.sep + "somedir" + os.path.sep + "somefile")
	\end{lstlisting}
	\end{exampleblock}
\end{frame}
